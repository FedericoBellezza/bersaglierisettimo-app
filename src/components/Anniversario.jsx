      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            >
              <div className="bg-red-600 text-white rounded-full px-6 py-2 text-lg font-bold">
                1995 - 2025
              </div>
            </motion.div>
              ...
              <div className="md:w-1/3 flex justify-center">
                <div className="relative">
                  ...
                  <div className="bg-white rounded-full p-4 shadow-lg relative">
                    <div className="bg-gradient-to-r from-red-500  to-orange-500 rounded-full text-center px-8 py-6 aspect-square">
